...
//      var backgroundImgs = ['DSC09051-highlight.jpg', 'DSC_9363-highlight2.jpg'];
	...
	function showWord($word, $duration) {
	    //	    $('#index-banner').css('background-image', 'url(img/'+backgroundImgs.next().value+')');
	    changeBackgroundImg($word);
		if($word.parents('.cd-headline').hasClass('type')) {
...
//     var instances = M.Carousel.init(elems, {numVisible: 3, noWrap: true, indicators: true, padding: 200});
//   });
